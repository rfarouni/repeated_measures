...
Compute the vector of estimated parameters $\hat{\boldsymbol \beta}$ for the simple regression problem given the data provided above.Hint: A fast way to create the matrix X uses the cbind() function to bind two vectors into a matrix. In R if one element is a scalar, the rbind function broadcasts (tranforms) the scalar into a vector.
