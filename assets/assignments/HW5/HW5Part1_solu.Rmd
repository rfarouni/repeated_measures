...
The likelihood ratio statistic of our model assumes that null hypothesis is that covariance matrix predicted by the model has the following decomposition:
$$
\begin{aligned}
